        ...
        <>
            ...
            <div className={styles.mobileContainer}>
                ...
                <div className={styles.mobileHeader}>
                    <div className={styles.mobileTextHeader}>
                        <Image
                            ...
                            style={{ marginLeft: '1em' }}
                        />
                        <p className={styles.mobileCategory}>{category}</p>
                    </div>
                    <p className={`${styles.mobileStatus} ${statusClassName}`}>{status}</p>
                </div>
                <hr className={styles.mobileDivider}></hr>

                <div className={styles.mobileContent}>
                    
                    <div className={styles.mobileInnerContent}>

                    </div>
                    <hr className={styles.mobileDividerVertical}></hr>
                    <div className={styles.mobileInnerContent}></div>
                    <hr className={styles.mobileDividerVertical}></hr>
                    <div className={styles.mobileInnerContent}></div>
                </div>
                ...
                <div className={styles.mobileTextContainer}>
                    ...
                    <div className={styles.mobileBudgetMoney}>
                        <p className={styles.mobileBudgetItem}>{budget !== undefined ? `$${budget}` : "-"}</p>
                        <p className={styles.mobileBudgetItem}>{spentValue}</p>
                        <p className={styles.mobileBudgetItem}>{leftValue}</p>
                        <p className={styles.mobileBudgetItem}>{overspentValue}</p>
                    </div>
                    <hr className={styles.mobileDivider}></hr>
                </div>
            </div>
